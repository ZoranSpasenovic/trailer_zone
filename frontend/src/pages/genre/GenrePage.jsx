...
const GenrePage = () => {
  ...
  const { content, loading } = useGenreSearch(selectedGenres, searchType);

  const genreNames = useGenres(selectedGenres, searchType);

  return (
    <div className="flex flex-col gap-4 py-8 bg-[#330022] text-[#FFD700] overflow-x-hidden min-h-screen">
